...
def define_model(numerical_columns, categorical_columns, k):
    ...
    if k > 1:
        return GridSearchCV(estimator=sklearn_model, param_grid=params, cv=k)
    else:
...
if sys.argv[0] == 'eyes' or __name__ == "__main__":
    ...
    sklearn_model = define_model(numerical_columns, categorical_columns, k)
